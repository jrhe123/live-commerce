...
import org.example.live.user.provider.rpc.UserRpcImpl;

public class DubboTest {

    private static final String REGISTER_ADDRESS = "nacos://127.0.0.1:8848?namespace=live-test&&username=nacos&&password=nacos";
